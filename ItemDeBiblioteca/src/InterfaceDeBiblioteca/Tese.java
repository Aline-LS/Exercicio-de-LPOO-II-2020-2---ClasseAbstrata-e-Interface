...
private boolean pegar;
    ...
    public void disponivel(){
        ...
        System.out.println("A tese está disponivel na estante");
    }
    @Override
    public void esprestado(){
        if(pegar == false)
            pegar = true;
                System.out.println("A tese já foi emprestado e estará emprestado por " + diasemprestimo + "dias.");
    ...
    public void emAtraso(){
        if(pegar == false)
            pegar = false;
                System.out.println("A tese ainda não foi devolvido");
    ...
    public void reservado(){
        if(pegar == true)
            pegar = true;
            System.out.println("A tese estará reservado por " + dias);
